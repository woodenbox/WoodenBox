...
<form method="POST">
	...
	<input type="text" name="username" placeholder="Username" pattern="[A-Za-z0-9]{4,}"  title="Must be at least 4 characters of letters or numbers are accepted." required/></br>
	<input type="password" name="password1" placeholder="Password" pattern="[A-Za-z0-9]{6,10}"  title="Must contain 6-10 characters of letters or numbers" required/></br>
	<input type="password" name="password2" placeholder="Password" pattern="[A-Za-z0-9]{6,10}"  title="Must contain 6-10 characters of letters or numbers" required/></br>
