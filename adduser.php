...
<form method="POST">
	<input type="text" name="first_name" placeholder="First Name" pattern="[A-Za-z]+" required/></br>
	...
	<input type="password" name="password1" placeholder="Password" pattern="[A-Za-z0-9]+" required/></br>
	<input type="password" name="password2" placeholder="Password" pattern="[A-Za-z0-9]+" required/></br>
